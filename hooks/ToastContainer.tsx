      ...
      {toasts.map((toast) => (
        <>
          ...
          {toast.type === "success" && (
            <div
              key={toast.id}
              className={`p-4 text-sm rounded-lg shadow-lg cursor-pointer toast-animate1 top-0 right-0 translate-x-[100%] bg-green-50 text-green-600 flex items-center gap-2 relative`}
            >
