...
const ToolsSections = dynamic(
  () => import("@/components/sections/marketing/tools/tools-section")
);
...
export const toolsData = [
  {
    ...
    seo_decsription:
      "Free Website Copy Generator. Simple. Easy. Free Chrome Extension to generate copy from browser itself in 2 clicks. Get it now. Zigment AI powerful free tool.",
    description:
      "Simple. Easy. Free Chrome Extension to generate copy from browser itself.",
    keywords: [
      "Website Copy",
      "Copy Generator",
      "AI Copy Generator",
  ...
  },
  {
    ...
    seo_decsription:
      "QR Generator is a straightforward tool that allows users to quickly generate QR codes from their browser with just two clicks.",
  ...
  // },
  {
    ...
    seo_decsription:
      "Effortlessly integrate WhatsApp messaging into your website with our easy-to-use WhatsApp Widget. Boost customer engagement and support with just a few clicks.",
    description:
      "Effortlessly integrate WhatsApp messaging into your website to enhance customer engagement and support.",
    keywords: [
      "WhatsApp Widget",
