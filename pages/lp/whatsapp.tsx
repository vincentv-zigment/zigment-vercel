...
const coaches = (props: Props) => {
  return (
    <>
      <MetaTagsComponents
        url="https://www.zigment.ai/lp/whatsapp"
              ...
              <div className=" mx-auto md:pb-16 lg:m-0 lg:p-0">
                ...
                <div className="flex  gap-4 items-center mt-4">
                  {heroBullets.map((x, index) => {
                    return (
                      <div className="flex gap-2  items-center" key={`hero_bullet_${index}`}>
                        <span><FaCheck className="w-4 h-4 text-brand-orange-main" /></span>
