...
function TermsOfService() {
  return (
    <>
      <div className='max-w-5xl mx-auto flex flex-col-reverse justify-between lg:flex-row items-center py-10 lg:py-14 markdown-content'>
        <section className='   pt-[100px] lg:flex   lg:flex-row lg:items-center'>
          <div className='flex-1 px-4 md:p-0 '>
            <h1 className='py-4 text-center text-4xl font-bold'>
              Refunds & Cancellation.
            </h1>
            <p> Last Updated: 20th Dec 2023</p>
            <div className='pt-4 tracking-wide	leading-relaxed space-y-4'>
              <p>
                {` 
                Thank you for choosing Zigment.ai, a subsidiary of Zigment Technologies Pvt Ltd, for your software and solution needs. We are committed to providing you with top-notch services that meet or exceed your expectations. We understand, however, that there may be circumstances where you may need to request a refund.
                Refund Eligibility`}
              </p>
              <p>
...
{`
              ...
              Refund Process
              Request Submission: To request a refund, please contact our customer support team at support@zigment.ai             and provide detailed information regarding the issue you encountered.
              `}
              </p>
              <p>
