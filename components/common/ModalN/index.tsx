...
export type widthsizes = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '4xl' | '5xl' | '6xl' | 'screen';
...
const Modal = ({ open, setOpenModal, children, height = '600px', width = '2xl', onKeyDown, className = '', zIndex = 20 }: ModalProps) => {
  ...
  return createPortal(
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative" style={{ zIndex }} onClose={setOpenModal}>
        ...
        <div
          className={`fixed inset-0 h-fit bg-white w-full max-w-${width} mx-auto top-1/2 -translate-y-1/2 rounded-md flex flex-col overflow-hidden ${className}`}
          style={{
