...
const Footer = () => {
  ...
  const { mutate, isLoading, isSuccess } = useMutation(subscribeEmail, {
        ...
        <div className="flex flex-col md:flex-row gap-y-3 w-full justify-between items-center py-4 md:py-9">
          ...
          <div className="w-full md:w-[340px]   flex flex-col sm:flex-row md:items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="https://twitter.com/Zigment_ai" target="_blank" aria-label="Follow us on Twiter">
                <svg
                  className="fill-black hover:fill-brand-orange-main"
                  width="32"
                  height="32"
              ...
              <Link href="https://www.youtube.com/@zigment01" className="w-8 h-8 bg-black hover:bg-brand-orange-main rounded-full flex items-center justify-center" target="_blank" aria-label="Follow us on Twiter">
      ...
      <div className="w-full mx-auto px-5 lg:px-16 text-black font-poppins pt-6 md:pt-14 pb-12 md:pb-28">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10  ">
          ...
          <div className="md:mx-auto w-full">
            ...
            />
            {isSuccess ? 
               <span className="block mt-2 text-sm text-green-500 pl-8">Email Submitted Successfully</span> :
