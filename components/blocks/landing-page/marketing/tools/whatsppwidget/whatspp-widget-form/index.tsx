...
import { ErrorI,   useWhatsappWidgetContext, WidgetDataI } from "@/pages/tools/whatsppwidget";
...
interface Props {
  ...
  errorState: ErrorI, 
  setErrorState: Dispatch<SetStateAction<ErrorI>>
    ...
    <div className="p-4 md:p-8 bg-white gap-4 mb-4 rounded-lg">
      ...
      <div className="mb-4">
        ...
        <div className="relative w-full md:w-80 lg:w-96">
          ...
          <PhoneNumberInput 
          className={`px-3 py-2 pr-10 border-2  ${errorState.phoneNumber  ? 'border-red-500' : 'focus:border-brand-orange-main'}  outline-none focus:ring-0 p-2 rounded w-full`}
                      setPhoneCode={(val) => {
                        setWidgetData({
                          ...widgetData,
                          countryCode: val,
        ...
        {errorState && <p className="text-red-500 text-sm mt-1">{errorState.phoneNumber}</p>}
      </div>
      <div className="mb-4">
