...
const AdComponent = ({setOpenModal, loading, downloadQR}:Props) => {
  ...
  return (
    <>
        <div className='fixed top-0 left-0 w-screen h-screen bg-black/20 z-[1000]' onClick={()=>setOpenModal(false)}/>
...
pitches, qualifies and converts leads 24/7
                    ...
                    <button
                        onClick={() =>{setDownloadClicked(true);downloadQR()}}
                        className="px-10 py-2 border-2 border-brand-orange-main bg-brand-orange-main  text-white hover:text-brand-orange-main hover:bg-transparent rounded-md  font-medium transition-all"
                    >
                        Download QR
                    </button>
                    <button
                        onClick={() => console.log('Sign Up Clicked')}
                        className="px-10 py-2 border-2 border-brand-orange-main text-brand-orange-main   bg-white   hover:text-white hover:bg-brand-orange-main  rounded-md  font-medium transition-all"
                    >
                        View Demo
                    </button>
                    </div>
