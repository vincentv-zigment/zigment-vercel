...
const QRCodeManager: React.FC<QRCodeManagerProps> = ({
  ...
  const buttonClasses = "font-bold text-white px-4 py-2 h-10 min-w-[80px]";
      ...
      <div className="w-full md:w-[400px] bg-white  mt-4 md:mt-0 p-4 flex flex-col items-center justify-start space-y-6">
        ...
        <div className=" w-full px-4 space-y-2">
          <button
            ...
            disabled={isLoading}
            className={`bg-brand-orange-main text-white rounded-md w-full ${buttonClasses} p-4`}
