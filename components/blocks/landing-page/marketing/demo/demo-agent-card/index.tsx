...
const DemoAgentCard = ({
  ...
  return (
    <div
      className="demo-agent-card space-y-4  border rounded-3xl border-gray-100 bg-white drop-shadow   p-8     "
      id={`demo_key_${demo.title}`}
    >
      <h3 className="text-lg font-bold tracking-tight text-gray-900 sm:text-2xl pb-2">
        {demo.title}
      </h3>
      <p id="description" className="text-gray-900 font-medium">{demo.description}</p>
      {demo.note && (
      ...
      <div className="pt-6">
        ...
        <div id="demo-links" className="flex items-center gap-4 mt-4">
