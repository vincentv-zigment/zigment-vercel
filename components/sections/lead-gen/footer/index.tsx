...
const Footer = () => {
  ...
  return (
    <footer className="px-4 md:px-10 lg:px-16  pb-0 mx-auto ">
      <div className=" bg-primary   px-10   rounded-t-[30px] ">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-y-[50px] gap-x-[60px] justify-between pt-[58px] pb-[51px] lg:pt-[78px] lg:pb-[71px]   2xl:pb-[121px]">
