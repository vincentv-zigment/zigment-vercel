        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-[auto_660px] gap-[30px] md:gap-[50px] 2xl:gap-[195px]">
          ...
          <div className="relative max-w-full lg:max-w-[630px] rounded-[40px] mx-auto bg-[#FAFAFA] mt-[50px] md:mt-0 p-0 md:px-[50px] md:py-[60px]">
              ...
              <Image
                ...
                data-speed="0.8"
                className="absolute w-[300px] drop-shadow-lg  object-contain top-6 md:top-[60px] left-1/4"
                alt="end-use-thumb"
              />
              <div className="h-[130px] max-w-full lg:max-w-[630px] flex items-center justify-center  absolute top-1/2 -translate-y-1/2 gap-2   left-1/2 -translate-x-1/2">
              <Image
                width={500}
                height={500}
              ...
              <Image
                ...
                data-speed="1.2"
                className="absolute w-[250px] drop-shadow-lg h-auto object-contain left-1/2 -translate-x-1/2 bottom-10 lg:bottom-[120px] md:bottom-[150px]"
                alt="community-thumb"
              />
          </div>
        </div>
