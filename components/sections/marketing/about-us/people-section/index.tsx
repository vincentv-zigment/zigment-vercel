      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:py-24 relative">
        <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          ...
          <div className="lg:col-span-2 relative z-10 has_fade_anim">
            <ul role="list" className="space-y-12 sm:-mt-8 sm:space-y-0 sm:divide-y sm:divide-gray-200 lg:gap-x-8 lg:space-y-0">
                    ...
                    <div className="sm:col-span-2">
                      <div className="space-y-4">
                        <div className="space-y-1 text-lg font-medium leading-6">
                          <h3>{person.name}</h3>
                          <p className="text-brand-orange-main">{person.role}</p>
                        </div>
                        <div className="text-lg">
                          <p className="text-gray-500 font-sans text-primary2">{person.bio}</p>
                        </div>
