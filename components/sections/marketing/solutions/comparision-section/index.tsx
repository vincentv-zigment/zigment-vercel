      ...
      <div className="relative mx-auto max-w-xl px-6 lg:max-w-7xl lg:px-0 lg:pl-8">
        <div className="relative     lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
          <div className="relative">
            ...
            <Link href={'/contactus'} className="  bg-brand-orange-main hover:bg-red-500 rounded-md right-2 inline-block text-white font-medium sm:font-semibold px-4 sm:px-8 mt-8 sm:py-3 py-2 text-sm sm:text-base">
              Start Here
            </Link>
          </div>
