...
const Switcher = ({ cursor1, cursor2 }: SwitcherType) => {
  ...
  const openSwitcher = () => {
    setOpen(true);
    switcherIcon.current.style[switcherDir as "left" | "right"] = "280px";
    switcherItems.current.style[switcherDir as "left" | "right"] = "0";
  };
  const closeSwitcher = () => {
    setOpen(false);
    switcherIcon.current.style[switcherDir as "left" | "right"] = "0";
    switcherItems.current.style[switcherDir as "left" | "right"] = "-280px";
  };
  const cursor = () => {
