      ...
      <div className="container" ref={containerRef}>
        <div className="grid grid-cols-1 lg:grid-cols-[7fr_6fr] gap-x-6 gap-y-12 items-center">
          ...
          <div>
            ...
            />
            <div className="  mt-[23px] lg:mt-[33px] max-w-[550px] mx-auto has_fade_anim">
            ...
            <div className="relative max-w-full lg:max-w-[630px] rounded-[40px] mx-auto bg-[#FAFAFA] my-8 md:mt-0 p-0 md:px-[50px] md:py-[60px] block md:hidden">
              <Image
                width={492}
                height={542}
                src={`/assets/imgs/lead-conversion/z_web_IG-04.png`}
